...
#加载数据
def LoadData(file):
    print "Locding file " + file
    input_data = codecs.open(file, 'r', 'utf-8')
    print "Locding file over!"
...
if __name__ == '__main__':
    ...
    #分离类别及正文文本
#     input_80w = LoadData("../data/80W.txt") 
#     get80w(input_80w)
#        
#     input_20w = LoadData("../data/20W.txt")
#     get20w(input_20w)

    NormalContent = LoadData("../data/100W.utf8")
    fwNormal = codecs.open("100WToshixiong.utf8","w","utf-8")
#        
    num = 1
